            ...
            <div className="navigation">
                ...
                <ul className="menu js__accordion">
                    <li className="current">
                        <a className="waves-effect" href="/dashboard"><i className="menu-icon fa fa-home"></i><span>Dashboard</span></a>
                    </li>
                    <li>
                        <a className="waves-effect parent-item js__control" href=""><i className="menu-icon fa fa-adjust"></i><span>Patient</span>
                            <span className="menu-arrow fa fa-angle-down"></span>
                        </a>
                        <ul className="sub-menu js__content">
                            <li><a href="/patients-onboard">Onboard</a></li>
                            <li><a href="/register-patient">New</a></li>
                            
                            <li><a href="#">Not Accepted</a></li>
                        </ul>
                        <a  href="/patients-onboard"><i className="menu-icon fa fa-adjust"></i>Processing Forms</a>
                        <a href="#"><i className="menu-icon fa fa-adjust"></i>Ongoing Process</a>
                        <a href="#"><i className="menu-icon fa fa-adjust"></i>Finised Process</a>
