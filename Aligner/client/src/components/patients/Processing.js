...
export const Processing = () => {
        ...
        <div class="content">
            ...
            <div class="navigation">
                ...
                <ul class="menu js__accordion">
                    ...
                    <li>
                        <a class="waves-effect" href="/patients-ongoing"><i class="menu-icon fa fa-code"></i><span>Ongoing Processes</span>
    ...
    <div class="fixed-navbar">
        <div class="pull-left">
            ...
            <h1 class="page-title">Processing Forms</h1>
            {/* <!-- /.page-title --> */}
        </div>
        {/* <!-- /.pull-left --> */}
                        ...
                        <table id="example-edit" class="display" style={{width: 100% + "%"}}>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Ongoing</td>
                                    <td>
                                        <a href="process_info.html" class="btn btn-danger">
                                        ...
                                        <a href="process_status.html" class="btn btn-primary">
                                            Status
                                        </a>
                                    </td>
                                </tr>
