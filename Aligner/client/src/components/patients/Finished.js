...
export const Finished = () => {
    ...
    <div class="fixed-navbar">
        <div class="pull-left">
            ...
            <h1 class="page-title">Processes Finished</h1>
            {/* <!-- /.page-title --> */}
        </div>
        {/* <!-- /.pull-left --> */}
                        ...
                        <table id="example-edit" class="display" style={{width: 100+"%"}}>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>2000</td>
                                    <td>
                                        <a href="finished_info.html" class="btn btn-danger">
                                        ...
                                        <a href="finished_info.html" class="btn btn-primary">
                                            Refinement
                                        </a>
