            ...
            <div class="content">
                ...
                <div class="navigation">
                    ...
                    <ul class="menu js__accordion">
                        ...
                        <li>
                            <a href="/patients-processing"><i class="menu-icon fa fa-adjust"></i><span>Processing Forms</span>
                            ...
                            <table id="example-edit" class="display" style={{width: 100+ '%'}}>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Processing</td>
                                        <td>
                                            <a href="process_status.html" class="btn btn-danger">
