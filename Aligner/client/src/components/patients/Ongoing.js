        ...
        <div>
                ...
                <div class="content">
                    ...
                    <div class="navigation">
                        ...
                        <ul class="menu js__accordion">
                            ...
                            <li>
                                <a class="waves-effect" href="/patients-finished"><i class="menu-icon fa fa-code"></i><span>Finished Processes</span>
                                    {/* <!-- <span class="notice notice-yellow">6</span> --> */}
                                </a>
                            </li>
                        </ul>
            ...
            <div class="fixed-navbar">
                <div class="pull-left">
                    ...
                    <h1 class="page-title">Ongoing Processes</h1>
                    {/* <!-- /.page-title --> */}
                </div>
                {/* <!-- /.pull-left --> */}
                                ...
                                <table id="example-edit" class="display" style={{width: 100+"%"}}>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>2021/02/25</td>
                                            <td>
                                                <a href="ongoing_info.html" class="btn btn-danger">
